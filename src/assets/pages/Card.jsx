...
export default function Card(props){
    ...
    return(
        ...
        <div class="max-w-sm bg-white border rounded-lg shadow-sm p-7 border-neutral-200">
            ...
            <p class="mb-4 text-neutral-500">Here are the biggest enterprise technology acquisitions of 2021</p>
